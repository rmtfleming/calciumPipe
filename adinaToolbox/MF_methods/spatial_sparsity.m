function [params] = spatial_sparsity()
%  DESCRIPTION:
%   initial parameters of Dictionary Learning using onlz spatial sparsity
%
%  USAGE:
%
...
params.all.modeD     = 1;
params.subList       = {'gamma1','batchsize','numThreads','iter','pos','posD'};