function [roi] = extractingROI_memory(dirBase,fileExt,stepChannel)
%  DESCRIPTION:
%    Main script for extracting neural activity. This scripts loads each block 
%   from the hard disk, and does not need to store all the image sequence
%   into RAM.
%
%  USAGE:
%
...
for i = 1:numBlocks,
    [InferCells(i)] = automaticROIextraction_memory(paramsOut(i));
end
