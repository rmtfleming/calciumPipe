function [cost] = MahalanobisDistance(muC,sigmaC,muP,sigmaP)
% DESCRIPTION:
%     compute the mahalanobis distance on a location
%
% USAGE:   
%       [cost] = MahalanobisDistance(muC,sigmaC,muP,sigmaP)
%
% ARGUMENTS:
...
%    ISBI 2013. Proceedings, (2013), 1058-1061".;
    cost = 1/(sqrt(2*pi*det(sigmaC)))*exp(-0.5*(muP-muC)'*inv(sigmaC)*(muP-muC));
end
